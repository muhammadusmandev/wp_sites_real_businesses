<?php
function rt_settings_url( $page = 'tss_settings' ) {
    ...
    <div class="settings-container">
        <div class="rt-settings-header-inner">
            <div class="settings-logo">
                <div class="rt-logo">
                    <img src="<?php echo  esc_url( TSSPro()->assetsUrl . 'images/testimonial-slider.gif' ); ?>" width="74px"
                         height="74px" alt="Testimonial Slider Showcase">
                </div>
                <div class="rt-content">
                    <h2><?php esc_html_e( 'Testimonial Slider Showcase', 'testimonial-slider-showcase' ); ?></h2>
            ...
            <div class="settings-menu">
                <a href="<?php echo esc_url( rt_settings_url() ); ?>">
                    ...
                    <?php esc_html_e( 'Settings', 'testimonial-slider-showcase' ); ?>
                </a>
                <a href="https://www.radiustheme.com/ticket-support/" target="_blank">
                    ...
                    <?php esc_html_e( 'Support', 'testimonial-slider-showcase' ); ?>
                </a>
                <a href="<?php echo esc_url( rt_settings_url( 'tss_get_help' ) ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
                    ...
                    <?php esc_html_e( 'Help', 'testimonial-slider-showcase' ); ?>
                </a>
                <a class="doc" href="<?php echo esc_url(TSSPro()->documentation_link()); ?>" target="_blank">
                    ...
                    <?php esc_html_e( 'Documentation', 'testimonial-slider-showcase' ); ?>
                </a>
            </div>
        </div>
    </div>
